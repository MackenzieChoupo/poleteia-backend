...
namespace Kreatys\CmsBundle\Provider;
...
class VideoProvider extends BaseProvider
{
    ...
    {
        return new Metadata($this->getName(), $this->getName().'.description', false, 'SonataMediaBundle', array('class' => 'fa fa-file-video-o'));
    }
    ...
    {
        return sha1($media->getName().rand(11111, 99999)).'.'.pathinfo($media->getName(), PATHINFO_EXTENSION);
    }
