...
class ContainerAnchorBlockService extends BaseBlockService {
...
//                        '3' => 'largeur 3'
                ...
                ->addSetting('anchor', null, array(
                    'label' => 'Nom de l\'ancre',
                    'required' => true,
                    'help_block' => 'Le nom doit être UNIQUE, en minuscule, sans espace, sans accent et composé de lettre et chiffre uniquement.'
                ))
                ->addSetting('menu', 'choice', array(
                    'label' => 'Inclure le menu',
                    'required' => true,
                    'choices' => array(
                        false => 'Non',
                        true => 'Oui'
                    ),
                    'help_block' => 'Inclure le menu dans le conteneur'
                ))
        ;
    }
    ...
    public function getName() {
        return 'Conteneur avec Ancre';
    }

    public function getTemplate() {
        return $this->container->getParameter('block_container_anchor');
    }
